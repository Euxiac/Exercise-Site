...
const getPatientsWithoutRecentAppointments = async () => {
  try {
    const [results] = await sequelize.query(`
...
const addNewPatient = async (name, age, gender) => {
  console.log(name);
...
module.exports = { getPatientsWithoutRecentAppointments, getAllPatients, addNewPatient, };